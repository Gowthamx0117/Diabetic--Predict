...
# Use a user-friendly approach to dynamically load the file
file_path = r"C:\Users\HP\Downloads\Diabetic Prediction Project\Diabetic Prediction Project\Diabetic Prediction Project\diabetes.csv"
